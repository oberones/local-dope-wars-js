      ...
      news: [
        {
          id: 99,
          tone: 'encounter',
          text: 'A rival crew boxed you in near Midtown with eyes on your Ecstasy.',
          spotlight: {
            tone: 'encounter',
            title: 'Jacker ambush',
            detail:
              'A rival crew corners you near Midtown. You can run it, fight back, or hand over 3 Ecstasy to get free.',
